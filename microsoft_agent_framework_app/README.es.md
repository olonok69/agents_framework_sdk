...
<p align="center">
  <img src="docs/architecture.svg" alt="Arquitectura de alto nivel de ms-agent-app" width="1080">
</p>
...
Fuente completa del diagrama: [`docs/architecture.svg`](docs/architecture.svg).
